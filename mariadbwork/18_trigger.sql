...
-- MENU 추가시 UPDATE 자동화 TRIGGER 만들기
...
DROP TRIGGERS after_order_menu_insert;
SHOW TRIGGERS;
-- 주문 테이블(TBL_ORDER)에 INSERT 후 주문메뉴테이블(TBL_ORDER_MENU)에
-- 주문한 메뉴마다 INSERT 후 주문테이블에 총금액 업데이트 확인
